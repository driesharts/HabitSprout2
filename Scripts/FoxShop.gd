...
var foxprice = Global.foxprice
var camera_of = 0

func _ready():
	Global.connect("actual_position", camera_offset)
	$Control/HBoxContainer/VBoxContainer/FoxPrice.text = str(Global.foxprice)

func camera_offset(new_position):
	camera_of = new_position.x

func _on_mouse_entered():
	if Global.coincount >= foxprice and Global.foxcount < Global.treecount -1:
...
func _on_texture_button_button_down():
	if Global.coincount >= foxprice and Global.foxcount < Global.treecount -1:
		...
		sprite = Sprite2D.new()
		sprite.texture = preload("res://Piskel/Sprite-fox.png")
		add_child(sprite)
